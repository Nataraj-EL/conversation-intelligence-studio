...
const PERSONAS: Persona[] = [
  {
    ...
    colorClass: "border-brand-blue/30 text-brand-blue"
  },
  {
    id: "price-sensitive",
    ...
    colorClass: "border-brand-peach/30 text-brand-peach"
  },
  {
    id: "angry-customer",
    name: "Angry Customer",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            Customer <span className="bg-gradient-to-r from-brand-purple to-brand-peach bg-clip-text text-transparent">Persona Simulator</span>
          </h2>
          ...
          {PERSONAS.map((persona) => {
            ...
            return (
              <button
                ...
                className={`glass-card rounded-2xl p-5 text-left flex flex-col justify-between h-[180px] hover:glass-card-hover transition-all duration-300 cursor-pointer ${
                  isSelected
                    ? "border-brand-purple ring-1 ring-brand-purple bg-brand-purple/5 shadow-[0_0_20px_rgba(139,92,246,0.15)]"
                    : "border-border-subtle"
                }`}
              >
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-bold text-white tracking-wide">{persona.name}</span>
                ...
                <div className="mt-3 flex justify-end">
                  <span className="text-[10px] uppercase font-bold text-brand-purple group-hover:text-white transition-colors">
        ...
        <div className="glass-card rounded-2xl p-6 md:p-8 relative overflow-hidden">
          ...
          {error && (
            <div className="rounded-xl border border-rose-500/20 bg-rose-950/30 px-4 py-3.5 text-sm text-rose-300 flex items-start gap-3">
            ...
            <div className="reveal-entry space-y-8">
              ...
              <div className="border-b border-border-subtle pb-6">
                <div className="flex items-center gap-2 mb-2.5">
                  <span className="text-xs font-semibold uppercase tracking-wider text-brand-purple font-mono">Simulated Target:</span>
                  <span className="text-sm font-bold text-white bg-brand-purple/10 border border-brand-purple/35 px-2.5 py-0.5 rounded-full">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5">
                  <div className="border border-brand-peach/20 bg-brand-peach/5 rounded-xl p-5 space-y-3">
                    ...
                    <div className="bg-bg-base/90 rounded-lg border border-border-subtle p-3.5 text-xs text-brand-peach whitespace-pre-wrap leading-relaxed">
                ...
                <div className="lg:col-span-7 flex flex-col">
                  <div className="border border-border-subtle bg-bg-base/20 rounded-xl p-5 flex flex-col h-[340px]">
